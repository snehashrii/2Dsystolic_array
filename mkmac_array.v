...
//
// On Fri Dec  8 12:48:49 IST 2023
//
//
// Ports:
// Name                         I/O  size props
...
module mkmac_array(CLK,
  ...
  // register input_load
  reg input_load;
  wire input_load$D_IN, input_load$EN;
  ...
  // register mac_r1_input_load
  reg mac_r1_input_load;
  wire mac_r1_input_load$D_IN, mac_r1_input_load$EN;
  ...
  // register mac_r2_input_load
  reg mac_r2_input_load;
  wire mac_r2_input_load$D_IN, mac_r2_input_load$EN;
  ...
  // register mac_r3_input_load
  reg mac_r3_input_load;
  wire mac_r3_input_load$D_IN, mac_r3_input_load$EN;
  ...
  // register mac_r4_input_load
  reg mac_r4_input_load;
  wire mac_r4_input_load$D_IN, mac_r4_input_load$EN;
  ...
  wire [31 : 0] mac_r1_inputFifo$D_IN, mac_r1_inputFifo$D_OUT;
  ...
  wire [31 : 0] mac_r2_inputFifo$D_IN, mac_r2_inputFifo$D_OUT;
  ...
  wire [31 : 0] mac_r3_inputFifo$D_IN, mac_r3_inputFifo$D_OUT;
  ...
  wire [31 : 0] mac_r4_inputFifo$D_IN, mac_r4_inputFifo$D_OUT;
  ...
  reg [31 : 0] x__h10375, x__h1999, x__h4793, x__h7584;
  wire NOT_mac_r1_psum_out_0_82_EQ_0_86_87_OR_NOT_mac_ETC___d197;
  ...
  // register input_load
  assign input_load$D_IN = top_cnn_input_load ;
  assign input_load$EN = EN_top_cnn_input ;
  ...
  // register mac_r1_input_load
  assign mac_r1_input_load$D_IN = input_load ;
  assign mac_r1_input_load$EN = 1'd1 ;
  ...
  // register mac_r2_input_load
  assign mac_r2_input_load$D_IN = input_load ;
  assign mac_r2_input_load$EN = 1'd1 ;
  ...
  assign mac_r2_psum_in11$EN =
	     NOT_mac_r1_psum_out_0_82_EQ_0_86_87_OR_NOT_mac_ETC___d197 ||
	     psum_out_0 != 32'd0 ;
  ...
  // register mac_r3_input_load
  assign mac_r3_input_load$D_IN = input_load ;
  assign mac_r3_input_load$EN = 1'd1 ;
  ...
  // register mac_r4_input_load
  assign mac_r4_input_load$D_IN = input_load ;
  assign mac_r4_input_load$EN = 1'd1 ;
  ...
  // submodule mac_r1_inputFifo
  assign mac_r1_inputFifo$D_IN = x__h1999 ;
  ...
  // submodule mac_r2_inputFifo
  assign mac_r2_inputFifo$D_IN = x__h4793 ;
  ...
  // submodule mac_r3_inputFifo
  assign mac_r3_inputFifo$D_IN = x__h7584 ;
  ...
  // submodule mac_r4_inputFifo
  assign mac_r4_inputFifo$D_IN = x__h10375 ;
  ...
  // remaining internal signals
  assign NOT_mac_r1_psum_out_0_82_EQ_0_86_87_OR_NOT_mac_ETC___d197 =
  ...
  begin
    case (mac_r1_n)
      8'd0: x__h1999 = mac_r1_0;
      8'd1: x__h1999 = mac_r1_1;
      8'd2: x__h1999 = mac_r1_2;
      8'd3: x__h1999 = mac_r1_3;
      default: x__h1999 = 32'hAAAAAAAA /* unspecified value */ ;
    endcase
  end
  always@(mac_r2_n or mac_r2_0 or mac_r2_1 or mac_r2_2 or mac_r2_3)
  begin
    case (mac_r2_n)
      8'd0: x__h4793 = mac_r2_0;
      8'd1: x__h4793 = mac_r2_1;
      8'd2: x__h4793 = mac_r2_2;
      8'd3: x__h4793 = mac_r2_3;
      default: x__h4793 = 32'hAAAAAAAA /* unspecified value */ ;
    endcase
  end
  always@(mac_r3_n or mac_r3_0 or mac_r3_1 or mac_r3_2 or mac_r3_3)
  begin
    case (mac_r3_n)
      8'd0: x__h7584 = mac_r3_0;
      8'd1: x__h7584 = mac_r3_1;
      8'd2: x__h7584 = mac_r3_2;
      8'd3: x__h7584 = mac_r3_3;
      default: x__h7584 = 32'hAAAAAAAA /* unspecified value */ ;
    endcase
  end
  always@(mac_r4_n or mac_r4_0 or mac_r4_1 or mac_r4_2 or mac_r4_3)
  begin
    case (mac_r4_n)
      8'd0: x__h10375 = mac_r4_0;
      8'd1: x__h10375 = mac_r4_1;
      8'd2: x__h10375 = mac_r4_2;
      8'd3: x__h10375 = mac_r4_3;
      default: x__h10375 = 32'hAAAAAAAA /* unspecified value */ ;
    endcase
  end
  ...
  begin
	...
	input_load <= `BSV_ASSIGNMENT_DELAY 1'd0;
	...
	mac_r1_input_load <= `BSV_ASSIGNMENT_DELAY 1'd0;
	...
	mac_r2_input_load <= `BSV_ASSIGNMENT_DELAY 1'd0;
	...
	mac_r3_input_load <= `BSV_ASSIGNMENT_DELAY 1'd0;
	...
	mac_r4_input_load <= `BSV_ASSIGNMENT_DELAY 1'd0;
	...
	if (input_load$EN)
	  input_load <= `BSV_ASSIGNMENT_DELAY input_load$D_IN;
	...
	if (mac_r1_input_load$EN)
	  mac_r1_input_load <= `BSV_ASSIGNMENT_DELAY mac_r1_input_load$D_IN;
	...
	if (mac_r2_input_load$EN)
	  mac_r2_input_load <= `BSV_ASSIGNMENT_DELAY mac_r2_input_load$D_IN;
	...
	if (mac_r3_input_load$EN)
	  mac_r3_input_load <= `BSV_ASSIGNMENT_DELAY mac_r3_input_load$D_IN;
	...
	if (mac_r4_input_load$EN)
	  mac_r4_input_load <= `BSV_ASSIGNMENT_DELAY mac_r4_input_load$D_IN;
  ...
  begin
    ...
    if (RST_N != `BSV_RESET_VALUE)
      $display("TB4 output %0d   %0d    %0d",
	       ...
	       psum_out3_3);
    if (RST_N != `BSV_RESET_VALUE)
      if (mac_r1_inputFifo$FULL_N && mac_r1_n < 8'd4 &&
	  (mac_r1_cycle ^ 32'h80000000) > 32'h80000001 &&
	  mac_r1_input_load)
	$display("%0d fifo", x__h1999);
    if (RST_N != `BSV_RESET_VALUE)
      if (mac_r2_inputFifo$FULL_N && mac_r2_n < 8'd4 &&
	  (mac_r2_cycle ^ 32'h80000000) > 32'h80000001 &&
	  mac_r2_input_load)
	$display("%0d fifo", x__h4793);
    if (RST_N != `BSV_RESET_VALUE)
      if (mac_r3_inputFifo$FULL_N && mac_r3_n < 8'd4 &&
	  (mac_r3_cycle ^ 32'h80000000) > 32'h80000001 &&
	  mac_r3_input_load)
	$display("%0d fifo", x__h7584);
    if (RST_N != `BSV_RESET_VALUE)
      if (mac_r4_inputFifo$FULL_N && mac_r4_n < 8'd4 &&
	  (mac_r4_cycle ^ 32'h80000000) > 32'h80000001 &&
	  mac_r4_input_load)
	$display("%0d fifo", x__h10375);
  end
  // synopsys translate_on
